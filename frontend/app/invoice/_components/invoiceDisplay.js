...
function InvoiceDisplay({
  ...
  console.log('InvoiceDisplay props:', { userProfile, serviceCost, existingInvoice, isEditable, preview });
  ...
  const displayMode = !preview && !existingInvoice;
  ...
  return (
    <div className="max-w-2xl mx-auto bg-gray-100 p-8 rounded-lg shadow-lg">
      ...
      {displayMode ? (
        <h2 className="text-2xl text-center font-bold mb-6">Invoice</h2>
      ) : (
        <>
          <div>
            <input
